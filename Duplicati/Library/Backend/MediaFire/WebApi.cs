...
namespace Duplicati.Library.Backend.WebApi
{
    public static class MediaFire
    {
        ...
        {
            return Uri.UriBuilder(Url.API, Path.UploadSessionStart);
        }

        public static string UploadSessionAppendUrl()
        {
            return Uri.UriBuilder(Url.API, Path.UploadSessionAppend);
        }

        public static string UploadSessionFinishUrl()
        {
            return Uri.UriBuilder(Url.API, Path.UploadSessionFinish);
        }

        public static string DownloadFilesUrl()
        {
            return Uri.UriBuilder(Url.API, Path.DownloadFiles);
        }

        public static string[] Hosts()
        {
            return new[] { new System.Uri(Url.API).Host, new System.Uri(Url.API).Host };

        }

        private static class Url
        {
            public const string API = "https://www.mediafire.com/api/1.5";
        }

        private static class Path
        {
            public const string CreateFolder = "folder/create.php";
            public const string DeleteFolder = "folder/delete.php";
            public const string ListFolder = "folder/get_content.php";
            ...
            public const string UploadSessionAppend = "upload/resumable.php";
            //public const string UploadSessionFinish = "files/upload_session/finish";

            public const string DownloadFiles = "file/get_links.php";
        }
